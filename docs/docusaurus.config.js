      ...
      },
      {
        ...
        innerHTML: JSON.stringify({
          ...
          "featureList": [
            ...
            "Supports Archlinux (experimental)",
            "Supports CentOS",
            "Supports Debian",
            "Supports Fedora",
            "Supports macOS",
            "Supports Qubes (experimental)",
            "Supports Ubuntu",
            "Supports Windows (experimental)"
          ],
          "fileSize": "5MB",
          "memoryRequirements": "200MB",
          "permissions": [
            "Notifications (optional)",
            "WiFi, 4G, or direct connection (recommended)",
            "E-mail address (for logged-in users)"
          ],
          ...
          "releaseNotes": "Install Doctor has spent years in the making and is now ready for use! Start using Install Doctor today!",
          ...
          "accessibilitySummary": "Currently we do not actively support screen readers or languages other than English - these features are on the road map so check back frequently."
        }),
      },
      {
        tagName: 'script',
        ...
        innerHTML: JSON.stringify({
          ...
          "award": "Workstation Provisioning System of the Year 2024 (Self-Given Award)",
          "sameAs": [
