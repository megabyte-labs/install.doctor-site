        ...
        var Zepto = (function () {
          ...
          $.isNumeric = function (val) {
            var num = Number(val),
              type = typeof val;
            return (
              (val != null && type != 'boolean' && (type != 'string' || val.length) && !isNaN(num) && isFinite(num)) ||
              false
            );
          };
          ...
          [
            {
              ...
              value: function getAutocompleteSource(transformData, queryHook) {
                ...
                return function (query, callback) {
                  ...
                  _this.client
                    .search([{ indexName: _this.indexName, query: query, params: _this.algoliaOptions }])
                    .then(function (data) {
    ...
    function (module, exports, __webpack_require__) {
      ...
      AlgoliaSearchCore.prototype._jsonRequest = function (initialOpts) {
        ...
        if (
          ...
          headers = this._computeRequestHeaders({ additionalUA: additionalUA, headers: initialOpts.headers });
        }
      ...
      AlgoliaSearchCore.prototype.search = function (queries, opts, callback) {
        ...
        var JSONPParams = map(postObj.requests, function prepareJSONPParams(request, requestId) {
          return (
            requestId +
            '=' +
            encodeURIComponent('/1/indexes/' + encodeURIComponent(request.indexName) + '?' + request.params)
          );
        }).join('&');
    ...
    function (module, exports, __webpack_require__) {
      ...
      IndexCore.prototype.searchForFacetValues = function (params, callback) {
        ...
        return this.as._jsonRequest({
          method: 'POST',
          url:
            '/1/indexes/' + encodeURIComponent(this.indexName) + '/facets/' + encodeURIComponent(facetName) + '/query',
          hostType: 'read',
          body: { params: searchParameters },
          callback: callback,
        });
      ...
      function buildDom(options) {
        ...
        $input
          ...
          .attr({
            ...
            role: 'combobox',
            'aria-autocomplete':
              options.datasets && options.datasets[0] && options.datasets[0].displayKey ? 'both' : 'list',
            'aria-expanded': 'false',
    ...
    function (module, exports, __webpack_require__) {
      ...
      _.mixin(Dropdown.prototype, EventEmitter, {
          ...
          if (this.isEmpty) {
            ...
            if (this.$empty) {
              if (query.length < this.minLength) {
                ...
                var html = this.templates.empty({ query: this.datasets[0] && this.datasets[0].query });
        ...
        _ensureVisible: function ensureVisible($el) {
          ...
          elBottom =
            elTop + $el.height() + parseInt($el.css('margin-top'), 10) + parseInt($el.css('margin-bottom'), 10);
    ...
    function (module, exports, __webpack_require__) {
      ...
      _.mixin(Dataset.prototype, EventEmitter, {
        _render: function render(query, suggestions) {
          ...
          if (this.$menu) {
            this.$menu
              .addClass(this.cssClasses.prefix + (hasSuggestions ? 'with' : 'without') + '-' + this.name)
              ...
              detailsIndex.search(source(first), detailsParams, function (error2, content2) {
                ...
                _.each(content2.facets, function (values, facet) {
                  _.each(values, function (count, value) {
                    suggestions.push(
                      _.mixin({ facet: { facet: facet, value: value, count: count } }, _.cloneDeep(first))
                    );
                  });
                });
