            ...
            <Grid>
              <Col md={6} sm={4} xs={12} cols={12} class="copyright">
                ...
                <div class="footer-social-wrapper">
                  ...
                  <a class="footer-social pinterest hint--top hint--rounded" href={this.defaults.social.pinterest} target="_blank" rel="noopener" aria-label="Pinterest">
                  ...
                  <a class="footer-social instagram hint--top hint--rounded" href={this.defaults.social.instagram} target="_blank" rel="noopener" aria-label="Instagram">
                    <ion-icon name="logo-instagram"></ion-icon>
                  </a>
                  <a class="footer-social threads hint--top hint--rounded" href={this.defaults.social.threads} target="_blank" rel="noopener" aria-label="Threads">
