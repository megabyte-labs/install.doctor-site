        ...
        return (
            <section id="hightop">
                ...
                <ResponsiveContainer>
                    ...
                    <p class="parallax-header reveal step-4">Discover Install Doctor's preloaded treasure trove: hundreds of top-rated utilities and plugins, including advanced AI tools, ready for your customization. Join our email newsletter and be the first to get exclusive updates on building the ultimate personalized desktop experience. Together, we can make desktop setup a thing of the past!</p>
                    <div class="btns">
                        <Button
                            class="reveal step-5"
                            kind="round"
                        ...
                        <newsletter-signup-parallax defaults={this.data.defaults} onSubmissionSuccess={() => { this.showCommunity = true }} onEmailInputBlur={(ev) => { this.inputBlur(ev) }} class={{
