...
export class PrivacyPolicyPage {
  ...
  CompanyLink = (linkText?: string) => {
    if (this.defaults.homepage === this.defaults.companyUrl) {
      return (
        <a {...href('/')} target="_blank" class="underline-hover link" rel="noopener">{linkText ? linkText : this.defaults.companyLegalName}</a>
      )
    } else {
      return (
        <a href={this.defaults.companyUrl} class="underline-hover link" target="_blank" rel="noopener">{linkText ? linkText : this.defaults.companyLegalName}</a>
      )
    }
  }

  PrivacyPolicy = () => (
    <ResponsiveContainer id="privacy-policy" class="legal-page" as="section">
      <Heading level={1} class="legal-heading">Privacy Policy</Heading>
      <Paragraph level={4}>
      ...
      <Paragraph level={4}>We collect information from you when you register on any of our affiliated web properties, sign up for notifications, or enter information on our site. In the case of some of our web properties, third-party analytics services are sometimes leveraged to help us create a better product.</Paragraph>
      <Heading level={3}>How do we use your information?</Heading>
      <Paragraph level={4}>We may use the information we collect from you when you register, make a purchase, sign up for our newsletter, respond to a survey or marketing communication, surf the website, or use certain other site features in the following ways:</Paragraph>
      <ul>
      ...
      <ul>
        ...
        <li>We use HTTPS encryption for data transfer whenever possible.</li>
        <li>We host our static site and some proxy endpoints via CloudFlare, keeping API keys secure.</li>
      </ul>
      <Paragraph level={4}>Your personal information is contained behind secured networks and is only accessible by a limited number of persons
      ...
      <Paragraph level={4}>We implement a variety of security measures when a user enters, submits, or accesses their information to maintain
        the safety of your personal information.</Paragraph>
      <Paragraph level={4}>All financial transactions are processed through a gateway provider and are not stored or processed on our servers.</Paragraph>
      <Heading level={3}>Do we use cookies?</Heading>
      <Paragraph level={4}>Yes. Cookies are small files that a site or its service provider transfers to your computer's hard drive through
      ...
      <Paragraph level={4}>We use cookies to:</Paragraph>
      <ul>
      ...
      <Paragraph level={4}>You can choose to have your computer warn you each time a cookie is being sent, or you can choose to turn off all
      ...
      <Paragraph level={4}>If you turn cookies off, Some of the features that make your site experience more efficient may not function properly.It
      ...
      <Paragraph level={4}>We do not sell, trade, or otherwise transfer to outside parties your Personally Identifiable Information unless we
      ...
      <Paragraph level={4}>Occasionally, at our discretion, we may include or offer third-party products or services on our website. These third-party
      ...
      <Paragraph level={4}>Google's advertising requirements can be summed up by Google's Advertising Principles. They are put in place to provide
      ...
      <Paragraph level={4}>We use Google AdSense Advertising on our website.</Paragraph>
      <Paragraph level={4}>Google, as a third-party vendor, uses cookies to serve ads on our site. Google's use of the DART cookie enables it
      ...
      <Paragraph level={4}>We have implemented the following:</Paragraph>
      <ul>
      ...
      <Paragraph level={4}>We, along with third-party vendors such as Google use first-party cookies (such as the Google Analytics cookies)
      ...
      <Paragraph level={4}>Users can set preferences for how Google advertises to you using the Google Ad Settings page. Alternatively, you
      ...
      <Paragraph level={4}>CalOPPA is the first state law in the nation to require commercial websites and online services to post a privacy
      ...
      <ul>
        ...
        <li>Our Privacy Policy link includes the word 'Privacy' and can easily be found in the footer navigation menu.</li>
      ...
      <Paragraph level={4}>We don't honor Do Not Track signals and Do Not Track, plant cookies, or use advertising when a Do Not Track (DNT)
      ...
      <Paragraph level={4}>It's also important to note that we allow third-party behavioral tracking.</Paragraph>
      <Heading level={3}>COPPA (Children Online Privacy Protection Act)</Heading>
      <Paragraph level={4}>When it comes to the collection of personal information from children under the age of 13 years old, the Children's
      ...
      <Paragraph level={4}>The Fair Information Practices Principles form the backbone of privacy law in the United States and the concepts
      ...
      <Paragraph level={4}>In order to be in line with Fair Information Practices we will take the following responsive action, should a data
      breach occur:
      </Paragraph>
      <ul>
      ...
      <Paragraph level={4}>We also agree to the Individual Redress Principle which requires that individuals have the right to legally pursue
      ...
      <Paragraph level={4}>The CAN-SPAM Act is a law that sets the rules for commercial email, establishes requirements for commercial messages,
      ...
      <Paragraph level={4}>We collect your email address in order to:</Paragraph>
      <ul>
      ...
      <Paragraph level={4}>To be in accordance with CANSPAM, we agree to the following:</Paragraph>
      <ul>
      ...
      <Paragraph level={4}>If at any time you would like to unsubscribe from receiving future emails, you can email us at <a class="underline-hover" href={'mailto:' + this.defaults.companyEmail}>{this.defaults.companyEmail}</a> or you can follow the instructions at the bottom of each email and we will promptly remove
      ...
      <div class="contact-info">
        ...
        <div class="contact-detail">
          ...
          <div class="contact-text">
            <a class="underline-hover link" href={'mailto:' + this.defaults.companyEmail}>{this.defaults.companyEmail}</a>
          </div>
        </div>
        <div class="contact-detail">
          ...
          <div class="contact-text">
            ...
            <br />{this.defaults.companyAddress.line3}
          </div>
        </div>
      </div>
    </ResponsiveContainer>
